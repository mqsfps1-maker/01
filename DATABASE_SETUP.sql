...
-- ============================================================================
-- Execute TODOS esses comandos em seu banco Supabase
-- Para usar: Copie todo este arquivo e execute no SQL Editor do Supabase
-- ============================================================================
...
-- Função para obter ID da organização atual
...
-- Função para verificar status de setup
...
-- Função para atualizar claims do usuário
...
-- Trigger para atualizar claims quando usuário é criado/modificado
...
BEGIN
  ...
  -- Obter dados de assinatura e plano
  ...
  -- Se não houver assinatura, usar padrão
