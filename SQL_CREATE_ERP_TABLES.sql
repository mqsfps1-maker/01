...
-- Planos de assinatura (se ainda não criado)
...
-- Usuários (frontend depende de auth.users + public.users)
...
-- Habilitar RLS (apenas se necessário após revisões das políticas próprias do banco)
...
SELECT 'ERP TABLES CREATED (IF MISSING)' AS status;
