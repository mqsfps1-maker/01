...
const AddItemModal: React.FC<AddItemModalProps> = ({ isOpen, onClose, itemType, onConfirm, prefillData, generalSettings }) => {
    ...
    useEffect(() => {
        if (isOpen) {
            ...
            if (generalSettings.productCategoryList.length > 0) {
                stateToSet.category = generalSettings.productCategoryList[0];
            }
    ...
    const getTitle = () => {
        switch(itemType) {
            ...
            case 'PRODUTO': return `Cadastrar Novo Produto`;
        }
    }
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-[var(--modal-bg)] text-[var(--modal-text-primary)] rounded-lg shadow-2xl p-6 w-full max-w-lg">
                ...
                <div className="space-y-4">
                    ...
                    {(itemType === 'INSUMO' || itemType === 'PRODUTO') && (
                        <div>
