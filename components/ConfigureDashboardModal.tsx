...
// FIX: Imported the 'Zap' icon from 'lucide-react' to be used in the 'Ações Rápidas' toggle button.
import { X, Palette, Text, Save, Volume2, Sun, Moon, Zap, ChevronRight, Laptop, Settings, LayoutDashboard, BarChart3, Package, Bell, History } from 'lucide-react';
