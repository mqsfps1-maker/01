...
const EmailConfirmedPage: React.FC<EmailConfirmedPageProps> = ({ onProceed }) => {
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen bg-slate-900 p-4 font-['Inter']">
            ...
            <div className="relative z-10 w-full max-w-md p-8 space-y-6 bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 text-center">
                ...
                <h1 className="text-3xl font-bold text-white">Email Confirmado com Sucesso!</h1>
                <p className="text-slate-300">
                    Sua conta foi ativada. O próximo passo é definir sua senha de acesso.
                </p>
                <button 
                    onClick={onProceed} 
                ...
                >
                    Prosseguir para Configuração <ArrowRight size={16} />
                </button>
            </div>
        </div>
    );
