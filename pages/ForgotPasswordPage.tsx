...
const ForgotPasswordPage: React.FC<ForgotPasswordPageProps> = ({ onNavigateToLogin, addToast }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (resetError) {
            ...
            addToast('Um link para redefinir sua senha foi enviado para seu e-mail.', 'success');
            onNavigateToLogin();
        }
            ...
            <div className="relative z-10 w-full max-w-md">
                <div className="w-full p-8 space-y-6 bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20">
                    ...
                    <p className="text-center text-sm">
                        <button onClick={onNavigateToLogin} className="font-medium text-blue-400 hover:underline flex items-center justify-center gap-1">
